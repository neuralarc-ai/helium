    ...
    <section className="w-full flex flex-col items-center py-6 px-2 md:px-8">
      ...
      <div className="max-w-7xl w-full mx-auto mb-10">
        <h2 className="text-white text-2xl md:text-3xl lg:text-4xl font-light mb-4">
          1. Why We Built Helium with a brilliant Helio o1 model (God Mode)?
        </h2>
        ...
        <ul className="list-disc pl-6 text-white/90 text-base md:text-lg mb-4 space-y-1">
      ...
      <div className="w-full flex flex-col gap-12 mb-8">
        ...
        <div className="flex flex-col items-center w-full max-w-6xl mx-auto">
          <Image src="/neuralarc/Helium-3.png" alt="Business Domain Performance Chart" width={700} height={400} className="object-contain w-full h-auto" />
          <p className="text-white/70 text-base md:text-lg lg:text-2xl mt-4 pb-4">
        ...
        <div className="flex flex-col items-center w-full max-w-6xl mx-auto">
          <Image src="/neuralarc/Helium-2.png" alt="Enterprise Cost Analysis" width={700} height={400} className="object-contain w-full h-auto" />
          <p className="text-white/70 text-base md:text-lg lg:text-2xl mt-4 pb-4">
        ...
        <div className="flex flex-col items-center w-full max-w-6xl mx-auto border-b border-b-[#FFFFFF26]">
        ...
        <div className="flex flex-col items-center w-full max-w-6xl mx-auto border-b border-b-[#FFFFFF26]">
          <Image src="/neuralarc/Helium.png" alt="Helio o1 Business AI Performance Benchmark" width={700} height={400} className="object-contain w-full h-auto" />
          <p className="text-white/70 text-base md:text-lg lg:text-2xl mt-4 pb-4">
