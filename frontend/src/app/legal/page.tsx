                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to Neural Arc Inc. (701 Tillery Street
                      ...
                      <li>
                        ...
                        Company, specifically support@neuralarc.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to support@neuralarc.ai and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at support@neuralarc.ai. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE HELIUM AI WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      HELIUM AI DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Helium AIin this statement
