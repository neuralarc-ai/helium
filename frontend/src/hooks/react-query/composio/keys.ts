export const composioKeys = {
    ...
    toolkitDetails: (toolkitSlug: string) => [...composioKeys.all, 'toolkit-details', toolkitSlug] as const,
    toolkitIcon: (toolkitSlug: string) => [...composioKeys.all, 'toolkit-icon', toolkitSlug] as const,
