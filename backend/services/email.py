...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'dev@neuralarc.ai')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'NeuralArc Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Helium AI — Let's Get Started "
...
<head>
  ...
  <title>Welcome to Helium AI</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/CKBHLZQG/helium-logo.png" alt="Helium AI Logo" class="logo">
    </div>
    <h1>Welcome to Helium AI!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Helium AI — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Helium AI community <span class="emoji">🌞</span></p>

    <p>— The Helium AI Team</p>

    <a href="https://www.he2.ai/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Helium AI — we're excited to have you on board!
...
Thanks again, and welcome to the Helium AI 🌞

— The Neural Arc Inc. Team

Go to the platform: https://www.he2.ai/

---
© 2025 Neural Arc Inc. All rights reserved.
You received this email because you signed up for a Helium AI account."""
