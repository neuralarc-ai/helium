-- Test script for global knowledge base context function
...
SELECT 
    ...
    created_at
FROM threads 
WHERE thread_id = '69e21687-85b4-4294-aa5a-1332bbf576ab';
...
-- 4. Check if there are any entries for the specific account (assuming we know the account_id)
...
SELECT 
    ...
    get_combined_knowledge_base_context('69e21687-85b4-4294-aa5a-1332bbf576ab'::UUID, NULL, 4000) as result; 